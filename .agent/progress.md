...
| TASK-M3-002 | 收集Bot B知识库文档（用户手册、蓝图） | ⏳ 待开始 — 需用户提供文档 |
...
| TASK-M3-006 | Bot B数据Embedding入库Qdrant | ⏳ 待开始 — 依赖 M3-002 |
| TASK-M3-006-1 | Embedding模型替换为bge-m3（支持中英文检索） | ⏳ 待确认 — 建议在Bot B入库前执行 |
...
**后续建议：**
- 尽快执行 TASK-M3-006-1（bge-m3 模型替换）
- 替换后需要重新索引所有中文内容
- 当前英文工单检索质量良好，无需重新处理
